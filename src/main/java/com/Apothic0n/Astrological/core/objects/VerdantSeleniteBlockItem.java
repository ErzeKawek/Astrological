...
public class VerdantSeleniteBlockItem extends BlockItem {
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> text, TooltipFlag flag) {
        ...
        text.add(1, Component.translatable(Util.makeDescriptionId("item", new ResourceLocation("astrological:verdant_selenite"))).withStyle(ChatFormatting.GREEN).withStyle(ChatFormatting.ITALIC));
    }
}
